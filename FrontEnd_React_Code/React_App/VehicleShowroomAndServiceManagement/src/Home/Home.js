...
const Home = () => {
  ...
  const[rightComp, setRightComp] = useState(<HomePage />);
        return(
        <div>
            <header id="site-header" class="fixed-top" /*className="bg-black"*/>
    <div class="container">
      <nav class="navbar navbar-expand-lg navbar-black">
        <h1><a class="navbar-brand" href="#">
            <span>C</span>arShowroom
          </a></h1>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <button onClick={() => setRightComp(<HomePage />)} className="btn btn-light">Home</button>
            {/* <a href='#'>Home</a>  */}
            </li>
            <li class="nav-item">
            <button onClick={() => setRightComp(/*<ContactUs />*/)} className="btn btn-light">About</button>
    ...
    <Dropdown.Menu variant="dark">
      <Dropdown.Item href="login/customer" active>
        Customer
      </Dropdown.Item>
      <Dropdown.Item href="#/login/employee">Employee</Dropdown.Item>
      <Dropdown.Item href="#/login/admin">Admin</Dropdown.Item>
      <Dropdown.Divider />
      <Dropdown.Item href="#/action-4">link</Dropdown.Item>
    </Dropdown.Menu>
  </Dropdown> */}
            <button onClick={() => setRightComp(/*<Login />*/)} className="btn btn-light">Login</button>
            {/* <a href='http://localhost:3000/admin/empMag'>Login</a>  */}
            </li>
          </ul>
          <ul class="navbar-nav search-right mt-lg-0 mt-2">
            <li class="nav-item mr-3" title="Search"><a href="#search" class="btn search-search">
                <span class="fa fa-search" aria-hidden="true"></span></a></li>
            <li class="nav-item"><button onClick={() => setRightComp(/*<About />*/)} className="btn btn-primary d-none d-lg-block btn-style mr-2">Contact Us</button></li>
          </ul>
          {/* btn btn-primary d-none d-lg-block btn-style mr-2 */}
                  ...
                  <div class="banner-info-bg">
                    ...
                    <div class="banner-buttons">
                      ...
                      <div id="small-dialog" class="zoom-anim-dialog mfp-hide">
                        <iframe src="https://player.vimeo.com/video/425349644" title="myFrame" allow="autoplay; fullscreen"
          ...
          <div class="col-lg-10 mx-auto">
            <div class="owl-testimonial owl-carousel owl-theme">
              <div class="item">
                <div class="slider-info mt-lg-4 mt-3">
                  <div class="img-circle">
                    <input type="image" img src="assets/images/team1.jpg" class="img-fluid rounded" alt="client image" />
                  </div>
              ...
              <div class="item">
                <div class="slider-info mt-lg-4 mt-3">
                  <div class="img-circle">
                  <input type="image" img src="assets/images/team2.jpg" class="img-fluid rounded" alt="client image" />
                  </div>
                  <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit
                    id
                    accusantium
              ...
              <div class="item">
                <div class="slider-info mt-lg-4 mt-3">
                  <div class="img-circle">
                  <input type="image" img src="assets/images/team3.jpg" class="img-fluid rounded" alt="client image"/>
                  </div>
                  <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit
                    id
                    accusantium
              ...
              <div class="item">
                <div class="slider-info mt-lg-4 mt-3">
                  <div class="img-circle">
                  <input type="image" img src="assets/images/team4.jpg" class="img-fluid rounded" alt="client image" />
                  </div>
                  <div class="message">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea sit
                    id
                    accusantium
                ...
                <div class="col-lg-4 col-md-6 sub-one-left pr-lg-4">
                  <h2><a class="navbar-brand" href="index.html">
                      <span>C</span>arserving
                                        ...
                                        <input type="image" img src="image-path" alt="Your logo" title="Your logo" style={{height:'35px'}} />
										</a> 
